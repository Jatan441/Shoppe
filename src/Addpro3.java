...
/**
 * Servlet implementation class Addpro3
 */
@WebServlet("/Addpro3")
public class Addpro3 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException ,IOException {
    	...
    	String qr="insert into products (name,price,oldprice,subcategory,company,Image,Image2,Image3,Image4,Status,Detail) values('"+name+"','"+price+"','"+oldprice+"','"+subcat+"','"+cmp+"','"+img1+"','"+img2+"','"+img3+"','"+img4+"','"+status+"','"+detail+"')";
