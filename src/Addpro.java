...
public class Addpro extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String qr="insert into products (name,price,oldprice,category,company,Image,Image2,Image3,Image4,Status,Detail) values('"+name+"','"+price+"','"+oldprice+"','"+cat+"','"+cmp+"','"+img1+"','"+img2+"','"+img3+"','"+img4+"','"+status+"','"+detail+"')";
