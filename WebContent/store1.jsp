				...
				<div class="container">
					...
					<div class="row">
						...
						{	
								...
								String subcat=rs1.getString("subcategory");
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartfromstore1.jsp" method="post">
				...
				<div class="row">
					...
					<!-- store products -->
						<div class="row">
							...
							<!-- product -->
							<% 
							String qr="Select * from products where sale is null and category is null limit 0,12";
							...
							<div class="col-md-4 col-xs-6" style="width: 215px; height: 430px">
								...
								<form action="Product.jsp" method="post">
									...
									<div class="product-body">
										...
										<form action="AddproIntoWishlistFromStore1.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="subcat" value="<%=subcat%>">
									...
									<form action="Addcartfromstore1.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
						...
						<div class="store-filter clearfix">
							...
							<ul class="store-pagination">
								...
								<li><a href="store2.jsp"><i class="fa fa-angle-right"></i></a></li>
							</ul>
						</div>
						<!-- /store bottom filter -->
					</div>
