					...
					<div class="row">
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartfromstore3.jsp" method="post">
				...
				<div class="row">
					...
					<!-- store products -->
						<div class="row">
							...
							<!-- product -->
							<% 
							String qr="Select * from products where subcategory is not null limit 25,36";
							...
							<div class="col-md-4 col-xs-6" style="width: 215px; height: 430px">
								...
								<form action="Product.jsp" method="post">
									...
									<form action="Addcartfromstore3.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
