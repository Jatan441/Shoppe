				...
				<ul class="">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 style="padding-top: 10px;" class="title">Log In into
								Admin Portal</h3>
						</div>
					</div>
				</ul>
			...
			<div class="col-md-5 order-details"
				...
				<div class="">
					<div class="section-title">
						<h4 class="title">Enter Admin ID & Password</h4>
					</div>
              ...
              <span style="right: 20px;" toggle="#password-field" class=" fa fa fa-eye field-icon toggle-password"></span>
						...
						<br> <a href="Aregs.html" style="color: black; float: left;">
							Create New ?</a> 
							<a href="Aforgotpass.jsp" style="color: black; float: right;">Forgot
							Password</a> <br> <br>
						<div>
