				...
				<ul class="">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 style="padding-top: 10px;" class="title">Update
								products from sale</h3>
						</div>
					</div>
				</ul>
...
.link {
	...
	<!-- SEARCH BAR -->
			...
			if(name!=null)
			{
			String query="select * from products where category is null and subcategory is null and name like '"+name+"%';";
