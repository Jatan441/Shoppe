					...
					<!-- LOGO -->
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartfromsale.jsp" method="post">
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
							<div style="">
							<h3 style="float: left; padding-left: 215px; padding-top: 10px;">Hurry Up Sale End In </h3>
							</div>
							<div style="padding-right: 270px;">
						 <h3 style=" padding-top:10px; 
					height:50px; width:400px; text-align:center; float:right; 
				...
				<div class="col-md-12">
					<div class="section-title">
						<h3 class="title">Search Results:</h3>
							...
							<!-- product -->
							<% 
							String qr="Select * from products where sale is not null and name like '"+name+"%'";
							...
							%>
							<div class="col-md-4 col-xs-6" style="width: 234px; height: 430px">
								<div class="product">
								<form action="Product.jsp" method="post">
									...
									<div class="product-body">
										...
										<form action="AddproIntoWishlistFromSale.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="sale" value="<%=sale%>">
									...
									<form action="Addcartfromsale.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="sale" value="<%=sale%>">
							...
							%>
										<!-- product -->
							<% 
							String qr="Select * from products where sale is not null";
							Statement st = con.createStatement();
							ResultSet rs=st.executeQuery(qr);
							if(rs.next())
