					...
					<div class="col-md-3 clearfix">
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartfromsmartphone.jsp" method="post">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h3 class="title">New Smartphones</h3>
					</div>
				</div>
			<%
						String qr="Select *from products where category='SMARTPHONE'";
				...
				<div class="col-md-3 col-xs-6">
					<div class="product">
						...
						<div class="product-body">
							...
							<form action="AddproIntoWishlistFromSmartphones.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
						...
						<div class="add-to-cart">
										<form action="Addcartfromsmartphone.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
