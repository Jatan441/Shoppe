				...
				<ul class="">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 style="padding-top: 10px;" class="title">Delete other
								products </h3>
						</div>
					</div>
				</ul>
	...
	<!-- SEARCH BAR -->
					...
					<center>
						<div class="header-search">
							<form action="Deletepro3.jsp" method="post">
			...
			if(name!=null)
			{
			String query="select * from products where category is null and sale is null and name like '"+name+"%'";
