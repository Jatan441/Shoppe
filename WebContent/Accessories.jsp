					...
					<div class="col-md-3 clearfix">
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartfromaccessories.jsp" method="post">
		...
		<div class="container">
			...
			<div id="responsive-nav">
				...
				<ul class="main-nav nav navbar-nav">
					...
					<li class="active"><a href="Accessories.jsp">Accessories</a></li>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<%
						String qr="Select * from products where category='Accessories' and price>2000";
				...
				<div class="col-md-3 col-xs-6">
					<div class="product">
						...
						<div class="product-body">
							...
							<form action="AddproIntoWishlistFromAccessories.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
						...
						<div class="add-to-cart">
										<form action="Addcartfromaccessories.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
