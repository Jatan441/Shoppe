					...
					<div class="row">
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartstore4.jsp" method="post">
				...
				<div class="row">
					...
					<!-- store products -->
						<div class="row">
							...
							<!-- product -->
							<% 
							String qr="Select * from products where subcategory is not null limit 37,48";
							...
							<div class="col-md-4 col-xs-6" style="width: 215px; height: 430px">
								...
								<form action="Product.jsp" method="post">
									...
									<div class="product-body">
										...
										<form action="AddproIntoWishlistFromStore4.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="subcat" value="<%=subcat%>">
									...
									<form action="Addcartfromstore4.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
						...
						<div class="store-filter clearfix">
							...
							<li><a href="store3.jsp"><i class="fa fa-angle-left"></i></a></li>
								<li><a href="store1.jsp">1</a></li>
								<li><a href="store2.jsp">2</a></li>
								<li><a href="store3.jsp">3</a></li>
								<li class="active">4</li>
								<li><a href="store5.jsp">5</a></li>
								<li><a href="store5.jsp"><i class="fa fa-angle-right"></i></a></li>
							</ul>
						</div>
						<!-- /store bottom filter -->
					</div>
