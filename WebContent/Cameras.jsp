					...
					<div class="col-md-3 clearfix">
						...
						%>
										...
										<button  style="border: none; background: none; text-align: left;">
											...
											<form action="Deletecartfromcamera.jsp" method="post">
		...
		<div class="container">
			...
			<div id="responsive-nav">
				...
				<ul class="main-nav nav navbar-nav">
					...
					<li class="active"><a href="Cameras.jsp">Cameras</a></li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						...
						<%
						String qr="Select *from products where category='CAMERA'";
				...
				<div class="col-md-3 col-xs-6">
					<div class="product">
						...
						<div class="product-body">
							...
							<form action="AddproIntoWishlistFromCameras.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
						...
						<div class="add-to-cart">
										<form action="Addcartfromcamera.jsp" method="post">
										<input type="hidden" name="name" value="<%=name%>">
										<input type="hidden" name="price" value="<%=price%>">
										<input type="hidden" name="oldprice" value="<%=oldprice%>">
										<input type="hidden" name="cat" value="<%=cat%>">
