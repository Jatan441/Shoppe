				...
				<ul class="">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 style="padding-top: 10px;" class="title">Current Active User</h3>
						</div>
					</div>
				</ul>
...
.link {
	...
	display: inline-block;
		...
		<%
			...
			String qr="Select * from User where email='"+id+"'";
...
{
	out.println("<h3>Currently No User</h3>");
}
%>
			</table>
			</center>
	...
	<!-- FOOTER -->
	<footer id="footer" style="height: 30%;">
		<!-- top footer -->
		<div class="section">
			<!-- container -->
			<div class="container">
