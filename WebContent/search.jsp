		...
		<div class="container">
			...
			<div class="row">
				...
				<%		if(!StringUtils.isNullOrEmpty(name))
						{
						String qr="select * from products where subcategory is null and name like '"+name+"%'";
						...
						{	
							...
							<div class="product-body">
								...
								<form action="AddproIntoWishlistFromSearch.jsp" method="post">
											<input type="hidden" name="name" value="<%=name%>">
											<input type="hidden" name="price" value="<%=price%>">
											<input type="hidden" name="oldprice" value="<%=oldprice%>">
											<input type="hidden" name="cat" value="<%=cat%>">
							...
							<div class="add-to-cart">
											<form action="Addcartfromsearch.jsp" method="post">
											<input type="hidden" name="name" value="<%=name%>">
											<input type="hidden" name="price" value="<%=price%>">
											<input type="hidden" name="oldprice" value="<%=oldprice%>">
											<input type="hidden" name="cat" value="<%=cat%>">
